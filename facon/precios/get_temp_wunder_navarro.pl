...
my $uvin = 0;
my $ej = "/root/precios/get_temp_wunder.pl --id";
...
my $ret = system("curl -k 'https://api.weather.com/v2/pws/observations/current?apiKey=e1f10a1e78da46f5b10a1e78da96f525&stationId=ILACOSTA4&numericPrecision=decimal&format=json&units=m' -H 'User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:89.0) Gecko/20100101 Firefox/89.0' -H 'Accept: application/json, text/plain, */*' -H 'Accept-Language: en-US,en;q=0.5' --compressed -H 'Origin: https://www.wunderground.com' -H 'DNT: 1' -H 'Connection: keep-alive' -H 'Referer: https://www.wunderground.com/' -H 'TE: Trailers' -k -o /tmp/salida.json");
