...
my $url = 'http://buscacatolica.es/cgi-bin/stats.pl';
...
my $url_press = "https://press.vatican.va";
...
my $str = "https://www.religionenlibertad.com";
my $rel_sum = $h->{$str};

my $str = "https://religionenlibertad.com";
my $rel_suma = $h->{$str};
my $rel_sum = $rel_sum + $rel_suma;

print "relliber ".$rel_sum."\n";
